...
const FooterNav = () => {
  return (
    <div className="max-w-screen-lg mx-auto fixed bottom-0 left-0 right-0 bg-footer-gradient text-white flex justify-around items-center px-[6px] shadow-lg z-50">
      <Link
        to="/patient/profile"
